...
/**
 * 此版本建立在AdaUniSignElfStarCompressor的基础上，区别是增加了数据预处理操作
 */
public class PreAdaUniSignElfStarCompressor implements ICompressor {
...
//    private int lastBetaStar = Integer.MAX_VALUE;
    ...
    public PreAdaUniSignElfStarCompressor(IXORCompressor xorCompressor, int window) {
...
//        this.betaStarList = new int[window + 1];     // one for the end sign
    ...
    public PreAdaUniSignElfStarCompressor(IXORCompressor xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
...
//            System.out.println("Key: " + entry.getKey() + ", Value: " + entry.getValue());
            ...
            if (voter > dbs.size()*0.1){
                ...
                preprocess = Math.pow(0.1,uniAlpha);
                return;
            }
        }
...
//        }
            ...
            vLong = Double.doubleToRawLongBits(v+preprocess);
            // C1: v is a normal or subnormal
