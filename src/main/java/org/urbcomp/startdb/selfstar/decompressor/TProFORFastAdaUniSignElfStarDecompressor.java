...
public class TProFORFastAdaUniSignElfStarDecompressor {
    ...
    public TProFORFastAdaUniSignElfStarDecompressor(IXORDecompressor xorDecompressor) {
...
//                        signList[signIdx++] = signValue;
//                    }
                    Arrays.fill(signList,signLength,signLength+signCnt,signValue);
                    signLength+=signCnt;
                }
            }else {
...
//                    }
                    Arrays.fill(noEraseList,noEraseListLength,noEraseListLength+eraseCnt,eraseValue);
