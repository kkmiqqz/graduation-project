...
public class UniSignElfStarDecompressor implements IDecompressor {
    ...
    public UniSignElfStarDecompressor(IXORDecompressor xorDecompressor) {
...
//        }
    ...
    private Double recoverVByBetaStar() {
        ...
        if (vPrime == 0 || Double.isInfinite(vPrime) || Double.isNaN(vPrime) ){
            System.out.print("");
        }
