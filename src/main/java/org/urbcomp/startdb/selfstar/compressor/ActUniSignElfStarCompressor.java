...
/**
 * 此版本建立在UniSignElfStarCompressor基础上，区别是启用了二值序列优化
 */
public class ActUniSignElfStarCompressor implements ICompressor {
...
//    private int lastBetaStar = Integer.MAX_VALUE;
    ...
    public ActUniSignElfStarCompressor(IXORCompressor xorCompressor, int window) {
...
//        this.betaStarList = new int[window + 1];     // one for the end sign
    ...
    public ActUniSignElfStarCompressor(IXORCompressor xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
