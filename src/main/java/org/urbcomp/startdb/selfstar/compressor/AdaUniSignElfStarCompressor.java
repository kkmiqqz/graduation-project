 ...
 */
public class AdaUniSignElfStarCompressor implements ICompressor {
...
//    private int lastBetaStar = Integer.MAX_VALUE;
    ...
    public AdaUniSignElfStarCompressor(IXORCompressor xorCompressor, int window) {
...
//        this.betaStarList = new int[window + 1];     // one for the end sign
    ...
    public AdaUniSignElfStarCompressor(IXORCompressor xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
