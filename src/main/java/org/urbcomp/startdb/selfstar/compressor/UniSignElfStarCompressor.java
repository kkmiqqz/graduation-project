...
/**
 * 此版本建立在UniElfStarCompressor的基础上，区别是提取了符号位进行单独存储压缩
 */
public class UniSignElfStarCompressor implements ICompressor {
...
//    private int lastBetaStar = Integer.MAX_VALUE;
    ...
    public UniSignElfStarCompressor(IXORCompressor xorCompressor, int window) {
...
//        this.betaStarList = new int[window + 1];     // one for the end sign
    ...
    public UniSignElfStarCompressor(IXORCompressor xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
