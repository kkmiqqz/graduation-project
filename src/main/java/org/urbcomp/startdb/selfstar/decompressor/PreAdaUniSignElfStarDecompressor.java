...
public class PreAdaUniSignElfStarDecompressor implements IDecompressor {
    ...
    public PreAdaUniSignElfStarDecompressor(IXORDecompressor xorDecompressor) {
...
//            if (uniAlpha<16)
            v = Elf64Utils.roundUp(vPrime, uniAlpha)-preprocess;
//            else{
