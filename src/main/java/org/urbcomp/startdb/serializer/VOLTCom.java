...
import org.urbcomp.startdb.serializer.VOLTComCommon.vector;
...
public class VOLTCom implements ISerializer{
    ...
    private double calcSED(gpsPoint s, gpsPoint m, gpsPoint e){
        double timeRatio = (m.getTimestamp() - s.getTimestamp()) / (e.getTimestamp() - s.getTimestamp());
