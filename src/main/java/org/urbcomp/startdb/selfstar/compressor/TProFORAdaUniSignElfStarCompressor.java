 ...
 * 启用二值优化的版本
 */
public class TProFORAdaUniSignElfStarCompressor implements ICompressor {
...
//    private int lastBetaStar = Integer.MAX_VALUE;
    ...
    public TProFORAdaUniSignElfStarCompressor(IXORCompressor xorCompressor, int window) {
...
//        this.betaStarList = new int[window + 1];     // one for the end sign
    ...
    public TProFORAdaUniSignElfStarCompressor(IXORCompressor xorCompressor) {
        this.xorCompressor = xorCompressor;
        this.os = xorCompressor.getOutputStream();
